<header id="header" class="header">
    <div class="top-left">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{route('admin.dashboard')}}"><img src="{{asset($logo)}}" alt="Logo" height="43px"></a>
            <a class="navbar-brand hidden" href="{{route('admin.dashboard')}}"><img src="{{asset($logo)}}" alt="Logo"></a>
...
{{--                </div>--}}
            ...
            <div class="user-area dropdown float-right">
                <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <strong class="mx-2">{{getSettings('site_name')}} ({{Auth::user()->name}})</strong>
